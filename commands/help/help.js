...
module.exports = {
  ...
  run: async (client, message, args ) => {
    ...
    .setLabel(`Fun, Images & Leveling`)
    .setID(`help3`)
    .setEmoji(`912288891204157471`)
    .setStyle("green");

    let button4 = new MessageButton()
    .setLabel(`Giveaway , Owner, UTILITY, Games`)
    .setID(`help4`)
    .setEmoji(`912288891204157471`)
    .setStyle("green");
