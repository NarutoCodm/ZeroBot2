  ...
  run: async (bot, message, args) => {
    ...
    if (user) {
      ...
      .setTitle(`${user.user.username}'s Balance`)
        .setColor("RANDOM")
        .setDescription(
          ` **Nice Balance sheeeeesh**
	  **Cash:** <:PinkBow:905136510720966716> ${bal}${emote.coin}\n**Bank:** <:PinkBow:905136510720966716> ${bank}${emote.coin}\n**Total:** <:PinkBow:905136510720966716> ${Total}${emote.coin}`
        );
